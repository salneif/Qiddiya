...
public class LavaCycle : MonoBehaviour
{
    ...
    [SerializeField] private float bucketStartY = 5.2813f;
    [SerializeField] private float bucketEndY = 2.99f;
    [SerializeField] private float bucketStartZ = 0.2076f;
    [SerializeField] private float bucketEndZ = -0.52f;
    [SerializeField] private float bucketStartScaleZ = -0.00036f;
    [SerializeField] private float bucketEndScaleZ = 0.174062f;
    ...
    void applyBucketLerp(float t)
    {
        ...
        pos.y = Mathf.Lerp(bucketStartY, bucketEndY, t);
        pos.z = Mathf.Lerp(bucketStartZ, bucketEndZ, t);
    ...
    void applyBucketRetract(float t)
    {
        ...
        Transform lf = bucketLava.transform;
        Vector3 pos = lf.localPosition;
        pos.y = Mathf.Lerp(bucketEndY, bucketStartY, t);
        pos.z = Mathf.Lerp(bucketEndZ, bucketStartZ, t);
        lf.localPosition = pos;
